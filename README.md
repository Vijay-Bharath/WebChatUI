...
### How to fix the initial import error?

1. To fix the import error,  we need to create HasMessages boolean attribute and Account_HasNewChat (1-*) association in the Administration module Account entity and give Read/Write access to that association.
2. Create 1-1 association between WebChatUI.User entity to Administration.Account entity [User_Account].
